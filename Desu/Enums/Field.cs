namespace Wacton.Desu.Enums
{
    public class Field : Enumeration
    {
        ...
        public static readonly Field Architecture = new Field(nameof(Architecture), "architecture, building");
        ...
        //public static readonly Field AudioVisual = new Field(nameof(AudioVisual), "audio-visual");
        ...
        //public static readonly Field Climate = new Field(nameof(Climate), "climate, weather");
        ...
        //public static readonly Field Embryology = new Field(nameof(Embryology), "embryology");
        ...
        //public static readonly Field Psychology = new Field(nameof(Psychology), "psychology, psychiatry");
        ...
        //public static readonly Field VideoGame = new Field(nameof(VideoGame), "video game");
