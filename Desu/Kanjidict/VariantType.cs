namespace Wacton.Desu.Kanjidict
{
    ...
    public class VariantType : Enumeration
    {
        ...
        public static readonly VariantType SpahnHadamitzky_TKD = new VariantType("Spahn & Hadamitzky: \"The Kanji Dictionary\" ", "s_h");
        ...
        public static readonly VariantType ONeill = new VariantType("O'Neill: \"Japanese Names\"", "oneill");
