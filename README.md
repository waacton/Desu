...
```
<details>
<summary>Click to see example return value of a radical lookup (radical to kanjis): 冂, [the index radical of 円](https://en.wikipedia.org/wiki/Radical_13)</summary>
...
```
<details>
<summary>Click to see example return value of a stroke lookup: 05186, [the 5-digit unicode number of 円](https://unicode-table.com/en/5186/)</summary>
